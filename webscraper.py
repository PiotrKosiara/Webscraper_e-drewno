...
for region in range(1, 2):
    ...
    while True:
        ...
        for row in data_rows:
            ...
            # if table_table:
            # print(table_table.find_all('tr'))
            # print(table_table.find_all('td'))
            # print(table_table.find_all('b'))
            # print(table_table.find('tbody'))
            ...
            if len(cols) >= 11:
                data = {
                    ...
                    "Termin na podpisanie umowy": table_2.find("td",
                                                               class_='aukcja_legend_agreementdeadline').text.strip(),
                    "Termin odbioru drewna": cols_2[1].text.strip(),
                    "Tel. kontaktowy": cols_2[2].text.strip(),
                    # "Przewidywany procentowy udział klas jakości i grubości": str(table_table.find_all('tr')),
                }
